                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('security-lapangan.detail-barang', $barang->id) }}" class="block text-center px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Detail Barang</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
