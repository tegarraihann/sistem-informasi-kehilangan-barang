...
Route::middleware(['auth', 'role:mahasiswa'])->group(function () {
    ...
    Route::get('mahasiswa/barang-temuan', [MahasiswaController::class, 'barangTemuan'])->name('mahasiswa.barang-temuan');
    Route::get('mahasiswa/barang-temuan/{id}', [MahasiswaController::class, 'show'])->name('mahasiswa.detail-barang');    Route::get('/histori-barang', [MahasiswaController::class, 'HistoriBarang'])->name('mahasiswa.histori-barang');
